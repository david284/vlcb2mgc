...
describe('cbusMessage tests', function(){
	...
	function GetTestCase_encodeFail () {
		...
		testCases.push({'test':{'mnemonic': 'EVLRN', 'eventVariableIndex':'3', 'eventVariableValue':'4'}, 'expected': 'encode: property \'eventIdentifier\' missing'});
		testCases.push({'test':{'mnemonic': 'EVLRN', 'eventIdentifier':"00000001", 'eventVariableValue':'4'}, 'expected': 'encode: property \'eventVariableIndex\' missing'});
		testCases.push({'test':{'mnemonic': 'EVLRN', 'eventIdentifier':"00000001", 'eventVariableIndex':'3'}, 'expected': 'encode: property \'eventVariableValue\' missing'});
    ...
    testCases.push({'test':{'mnemonic': 'ARON2', 'eventNumber': '2', 'data1':'3', 'data2':'4'}, 'expected': 'encode: property \'nodeNumber\' missing'});
		...
		testCases.push({'test':{'mnemonic': 'EVLRNI', 'eventNumberIndex':'3', 'eventVariableIndex':'4', 'eventVariableValue':'5'}, 'expected': 'encode: property \'eventIdentifier\' missing'});
		testCases.push({'test':{'mnemonic': 'EVLRNI', 'eventIdentifier': "00000001", 'eventVariableIndex':'4', 'eventVariableValue':'5'}, 'expected': 'encode: property \'eventNumberIndex\' missing'});
		testCases.push({'test':{'mnemonic': 'EVLRNI', 'eventIdentifier': "00000001", 'eventNumberIndex':'3', 'eventVariableValue':'5'}, 'expected': 'encode: property \'eventVariableIndex\' missing'});
		testCases.push({'test':{'mnemonic': 'EVLRNI', 'eventIdentifier': "00000001", 'eventNumberIndex':'3', 'eventVariableIndex':'4'}, 'expected': 'encode: property \'eventVariableValue\' missing'});
	...
	itParam("Generic encode fail test - ${JSON.stringify(value.test)}", GetTestCase_encodeFail(), function (value) {
        ...
        expect(() => vlcb2mgc.encode(value.test)).to.throw(Error).with.property('message', value.expected);
	})
